 ...
 * @param {Function} specDefinitions Function for Jasmine to invoke that will define inner suites and specs
 */
function fdescribe_implementation(description, specDefinitions) {
	return implementation_iterator(description, specDefinitions, fdescribe);
}

/**
 * A temporarily disabled [`describe_implementation`]{@link describe_implementation}
 * Specs within an `xdescribe_implementation` will be marked pending and not executed
 * @param {String} description Textual description of the group
 * @param {Function} specDefinitions Function for Jasmine to invoke that will define inner suites and specs
 */
function xdescribe_implementation(description, specDefinitions) {
	return implementation_iterator(description, specDefinitions, xdescribe);
}

/**
 * Hacking our custom suite functions to `global`
 */
(function() {
	global.describe_implementation = describe_implementation;
	global.fdescribe_implementation = fdescribe_implementation;
	global.xdescribe_implementation = xdescribe_implementation;
})();
